...
|---|---|---|
| [Grafana Cloud](grafana/) | Ansible instruments OpenShift, OpenShift Virtualization and AAP, pushes a dashboard and alert rules as code, and Claude reads the result through a read-only MCP server | **Draft** — screenshots and captured answers landing now ([#82](https://github.com/ericcames/sales.demos-docs/issues/82)) |
