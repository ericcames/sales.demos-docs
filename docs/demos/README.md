...
| [Observability — Grafana Cloud](observability/grafana/) | Platform engineers, SREs and automation leads | 20 min | **Draft** — instance expires 2026-09-22; screenshots in progress ([#82](https://github.com/ericcames/sales.demos-docs/issues/82)) |
